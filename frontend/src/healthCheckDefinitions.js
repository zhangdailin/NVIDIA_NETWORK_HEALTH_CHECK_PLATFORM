...
const HEALTH_CHECK_GROUPS = [
  {
    ...
    checks: ['cable', 'cable_enhanced', 'links', 'port_health'],
  },
  {
    key: 'congestion',
    label: '拥塞与带宽',
...
const HEALTH_CHECK_DEFINITIONS = {
  ...
  cable_enhanced: {
    key: 'cable_enhanced',
    label: 'Cable Enhanced',
    group: 'connectivity',
    dataKey: 'cable_enhanced_data',
    totalKey: 'cable_enhanced_total_rows',
    summaryKey: 'cable_enhanced_summary',
    description: '增强型光缆属性与温度/功率异常',
  },
  links: {
    key: 'links',
    label: 'Links',
    group: 'connectivity',
    dataKey: 'links_data',
    totalKey: 'links_total_rows',
    summaryKey: 'links_summary',
    description: '链路活动与硬件错误状态',
  },
  port_health: {
    key: 'port_health',
    label: 'Port Health',
    group: 'connectivity',
    dataKey: 'port_health_data',
    totalKey: 'port_health_total_rows',
    summaryKey: 'port_health_summary',
    description: '端口健康摘要 (down, flapping 等)',
  },
  xmit: {
    key: 'xmit',
    label: 'Xmit 拥塞',
  ...
  per_lane_performance: {
    ...
    label: 'Per-Lane 性能',
    group: 'congestion',
    dataKey: 'per_lane_performance_data',
  ...
  extended_port_info: {
    ...
    label: 'Extended Port',
    group: 'diagnostics',
    dataKey: 'extended_port_info_data',
  ...
  extended_node_info: {
    ...
    label: 'Extended Node',
    group: 'diagnostics',
    dataKey: 'extended_node_info_data',
  ...
  extended_switch_info: {
    ...
    group: 'diagnostics',
    dataKey: 'extended_switch_info_data',
